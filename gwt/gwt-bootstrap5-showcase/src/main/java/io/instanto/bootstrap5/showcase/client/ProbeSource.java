...
/**
 * The UiBinder template, embedded as text so the showcase can display the file it actually renders
 * from. Hand-copied snippets drift from the code beside them; this one cannot.
 */
