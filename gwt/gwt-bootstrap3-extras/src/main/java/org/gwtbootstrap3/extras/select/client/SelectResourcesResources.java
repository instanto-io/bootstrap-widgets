...
/**
 * How bootstrap-select arrives on GWT: the {@link SelectEntryPoint} injects it.
 *
 * <p>TeaVM builds leave this class out. The resources plugin generates a {@code SelectResourcesResources}
 ...
 */
public final class SelectResourcesResources {
    ...
    private SelectResourcesResources() {
    }
