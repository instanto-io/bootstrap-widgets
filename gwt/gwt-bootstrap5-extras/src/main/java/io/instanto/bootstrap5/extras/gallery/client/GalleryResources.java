...
/**
 * How PhotoSwipe arrives on GWT: compiled into the application through
 * {@link GalleryClientBundle} and injected by {@link GalleryEntryPoint} before it runs.
 *
 * <p>TeaVM builds leave this class out. The resources plugin generates a
 * {@code GalleryResources} with the same methods there, which fetches the library by URL,
