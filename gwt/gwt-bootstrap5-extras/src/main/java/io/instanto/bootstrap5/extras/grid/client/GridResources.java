...
/**
 * How Tabulator arrives on GWT: compiled into the application through
 * {@link GridClientBundle} and injected by {@link GridEntryPoint} before it runs.
 *
 * <p>TeaVM builds leave this class out. The resources plugin generates a
 * {@code GridResources} with the same methods there, which fetches the library by URL,
