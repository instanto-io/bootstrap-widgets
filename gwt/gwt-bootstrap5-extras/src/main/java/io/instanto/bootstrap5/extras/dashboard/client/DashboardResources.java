...
/**
 * How GridStack arrives on GWT: compiled into the application through
 * {@link DashboardClientBundle} and injected by {@link DashboardEntryPoint} before it runs.
 *
 * <p>TeaVM builds leave this class out. The resources plugin generates a
 * {@code DashboardResources} with the same methods there, which fetches the library by URL,
