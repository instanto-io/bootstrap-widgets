 ...
 *
 * <p>Replaces the "We support Markdown" link that sends an author to commonmark.org and loses their
 * draft. The same syntax, collapsed until asked for, covering what a flexmark server with the GFM
 * extensions accepts.
 */
