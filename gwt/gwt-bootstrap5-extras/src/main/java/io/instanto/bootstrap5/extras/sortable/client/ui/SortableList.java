...
public class SortableList extends PluginWidget<SortableJs.Sortable>
    implements HasEnabled, HasValueChangeHandlers<List<Widget>> {
  ...
  public void add(Widget child) {
    child.addStyleName("list-group-item");
    super.add(child);
  }
  ...
  @Override
  public HandlerRegistration addValueChangeHandler(ValueChangeHandler<List<Widget>> handler) {
    return addHandler(handler, ValueChangeEvent.getType());
  }

  @Override
  protected void whenReady(Runnable action) {
    SortableJs.whenReady(action);
  }

  @Override
  protected SortableJs.Sortable createPlugin() {
    return SortableJs.create(getElement(), group, enabled, this::moved);
  }

  @Override
  protected void afterCreate() {
    ATTACHED.put(owner, this);
  }
  ...
  @Override
  protected void destroyPlugin(SortableJs.Sortable plugin) {
