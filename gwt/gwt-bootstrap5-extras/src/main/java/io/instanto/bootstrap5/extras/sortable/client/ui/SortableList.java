...
public class SortableList extends PluginWidget<SortableJs.Sortable> implements HasEnabled, HasValueChangeHandlers<List<Widget>> {
    ...
    @Override protected SortableJs.Sortable createPlugin() {
    ...
    @Override protected void destroyPlugin(SortableJs.Sortable plugin) {
