...
/**
 * How Tom Select arrives on GWT: compiled into the application through
 * {@link SelectClientBundle} and injected by {@link SelectEntryPoint} before it runs.
 *
 * <p>TeaVM builds leave this class out. The resources plugin generates a
 * {@code SelectResources} with the same methods there, which fetches the library by URL,
