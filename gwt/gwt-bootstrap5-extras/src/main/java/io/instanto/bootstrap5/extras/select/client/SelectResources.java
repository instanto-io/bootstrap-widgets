...
/**
 * How Tom Select arrives on GWT: compiled into the application through {@link SelectClientBundle}
 * and injected by {@link SelectEntryPoint} before it runs.
 *
 * <p>TeaVM builds leave this class out. The resources plugin generates a {@code SelectResources}
 ...
 */
public final class SelectResources {
  ...
  public static void whenReady(final Presence presence, final Runnable action) {
    if (presence.isPresent()) {
      ...
      throw new IllegalStateException("Inherit the Select module to load TomSelect");
    }
  }
