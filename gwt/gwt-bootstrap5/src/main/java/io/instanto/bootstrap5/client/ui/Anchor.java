...
public class Anchor extends ElementPanel
  ...
  public void setTargetHistoryToken(String targetHistoryToken) {
    ...
    setHref(
        targetHistoryToken == null ? "#" : "#" + History.encodeHistoryToken(targetHistoryToken));
  }
  ...
  public void setButtonType(ButtonType type) {
    ...
    StyleHelper.addUniqueEnumStyleName(
        this, ButtonType.class, type == null ? ButtonType.DEFAULT : type);
  }
