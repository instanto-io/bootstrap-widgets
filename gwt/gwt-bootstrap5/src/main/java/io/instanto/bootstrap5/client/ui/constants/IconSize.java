 ...
 *
 * <p>Bootstrap 3 sized icons with the Font Awesome step classes ({@code fa-lg}, {@code fa-2x} …
 * {@code fa-5x}). Bootstrap Icons ships no size classes of its own — its documentation sizes icons
 * with {@code font-size} — so these constants map onto Bootstrap's own {@code fs-*} scale and need
 * no stylesheet from this library. The scale runs 1rem to 2.5rem; for anything larger, set {@code
 * font-size} directly.
 */
