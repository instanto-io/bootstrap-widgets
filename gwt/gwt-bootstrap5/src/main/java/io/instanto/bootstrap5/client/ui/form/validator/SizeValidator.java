...
/**
 * Validator for checking the length of a map, array, collection, or string value. If type is not
 * one of the aformentioned, the {@link Object#toString()} method is called to get the string
