 ...
 * Validation messages.
 *
 * <p>Message functions should be the key with "_" replacing any periods. This allows the
...
public interface ValidationMessages extends ConstantsWithLookup {
  ...
  public static class Keys {
    ...
    public static final String BLANK = "io.instanto.bootstrap5.validation.Blank.message";

    public static final String DECIMAL_MAX = "io.instanto.bootstrap5.validation.DecimalMax.message";

    public static final String DECIMAL_MIN = "io.instanto.bootstrap5.validation.DecimalMin.message";

    public static final String FIELD_MATCH = "io.instanto.bootstrap5.validation.FieldMatch.message";

    public static final String FUTURE = "io.instanto.bootstrap5.validation.Future.message";

    public static final String PAST = "io.instanto.bootstrap5.validation.Past.message";

    public static final String REGEX = "io.instanto.bootstrap5.validation.RegEx.message";

    public static final String SIZE = "io.instanto.bootstrap5.validation.Size.message";
  }
