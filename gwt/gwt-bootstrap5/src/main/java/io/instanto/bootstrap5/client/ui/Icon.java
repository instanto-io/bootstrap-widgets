...
public class Icon extends ElementPanel
    implements HasType<IconType>, HasSize<IconSize>, HasEmphasis, HasClickHandlers {
  ...
  /**
   * Names the icon, with or without the {@code bi-} prefix. This and {@link #setType(IconType)} are
   * the same setting; whichever is called last wins, and the previous icon class is removed.
   */
  ...
  private String normalize(String iconName) {
    ...
    return trimmed.startsWith(Styles.ICON_PREFIX)
        ? trimmed.substring(Styles.ICON_PREFIX.length())
        : trimmed;
  }
  ...
  /**
   * Marks this icon as the larger background icon of an {@link IconStack} when true, or the smaller
   * foreground icon when false.
   */
  ...
  public void setRotate(IconRotate iconRotate) {
    StyleHelper.addUniqueEnumStyleName(
        this, IconRotate.class, iconRotate == null ? IconRotate.NONE : iconRotate);
  }
  ...
  public void setFlip(IconFlip iconFlip) {
    StyleHelper.addUniqueEnumStyleName(
        this, IconFlip.class, iconFlip == null ? IconFlip.NONE : iconFlip);
  }
  ...
  public void setSize(IconSize iconSize) {
    StyleHelper.addUniqueEnumStyleName(
        this, IconSize.class, iconSize == null ? IconSize.NONE : iconSize);
  }
