...
public class Column extends Div {
  ...
  private <E extends Enum<? extends Style.HasCssName>> void addEnumVarargsValues(
      final E[] values, final Class<E> enumClass, final boolean clearOld) {
    if (clearOld) {
  ...
  private <E extends Enum<? extends Style.HasCssName>> void addEnumStringValues(
      final String values, final Class<E> enumClass, final boolean clearOld) {
    if (clearOld) {
      removeStyleNames(enumClass);
    }
  ...
  private <E extends Enum<? extends Style.HasCssName>> void removeStyleNames(
