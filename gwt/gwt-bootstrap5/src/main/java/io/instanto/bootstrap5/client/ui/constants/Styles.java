...
public final class Styles {
    ...
    public static final String ALERT_DISMISSABLE = "alert-dismissible";
    ...
    public static final String BTN_BLOCK = "w-100";
    ...
    public static final String PULL_LEFT = "float-start";
    public static final String PULL_RIGHT = "float-end";
    ...
    public static final String SR_ONLY = "visually-hidden";
