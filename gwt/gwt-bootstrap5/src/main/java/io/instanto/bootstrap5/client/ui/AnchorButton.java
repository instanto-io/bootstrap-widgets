 ...
 *
 * <p>Extends {@link AbstractToggleButton}, so it has the whole button surface: {@code setActive},
 * {@code toggle()}, {@code state()} with its loading text, sizes, block layout, the mouse handlers
 * and {@code setDataToggle}. Rendering it as an anchor rather than a button is the only difference
 * from {@link Button}.
 */
