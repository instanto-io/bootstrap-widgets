...
import io.instanto.bootstrap5.client.ui.gwt.ButtonBase;
import io.instanto.bootstrap5.client.ui.gwt.Widget;
import io.instanto.bootstrap5.client.ui.impl.CheckBoxImpl;

/**
 * A standard check box widget.
 *
 * <p>This class also serves as a base class for {@link Radio}.
 *
 * <p>
 *
...
public class CheckBox extends ButtonBase
   ...
   * will be associated with the CheckBox name and submitted to the server if a form that holds it
   * is submitted and the box is checked.
   *
   ...
   * be associated with the CheckBox's name and submitted to the server if a form that holds it is
   * submitted and the box is checked.
   *
