...
import io.instanto.bootstrap5.client.ui.base.HasFormValue;
...
import io.instanto.bootstrap5.client.ui.gwt.Widget;
import io.instanto.bootstrap5.client.ui.impl.SimpleRadioButtonImpl;
...
public class SimpleRadioButton extends com.google.gwt.user.client.ui.SimpleRadioButton
  ...
  private final EnabledMixin<SimpleRadioButton> enabledMixin =
      new EnabledMixin<SimpleRadioButton>(this);
   ...
   * must be an &lt;input&gt; element whose type is 'radio'.
   *
   * @param element the element to be used
   */
  protected SimpleRadioButton(InputElement element) {
    super(element);
    addStyleName("form-check-input");
  }
