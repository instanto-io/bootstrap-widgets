...
import io.instanto.bootstrap5.client.ui.form.validator.RadioGroupBlankValidatorMixin;
 ...
 */
public class RadioGroupBase<T> extends FlowPanel
    implements HasName,
        HasValue<T>,
        LeafValueEditor<T>,
        HasEditorErrors<T>,
  ...
  private final BlankValidatorMixin<RadioGroupBase<T>, T> validatorMixin =
      new RadioGroupBlankValidatorMixin<RadioGroupBase<T>, T>(
          this, errorHandlerMixin.getErrorHandler());

  private final Map<Radio, HandlerRegistration> valueChangedRegistrations =
      new HashMap<Radio, HandlerRegistration>();
