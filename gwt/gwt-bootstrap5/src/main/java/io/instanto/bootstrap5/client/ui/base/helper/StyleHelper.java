package io.instanto.bootstrap5.client.ui.base.helper;
...
import io.instanto.bootstrap5.client.ui.constants.Responsiveness;
...
public final class StyleHelper {
   ...
   * @see #addEnumStyleName(com.google.gwt.user.client.ui.UIObject,
   *     com.google.gwt.dom.client.Style.HasCssName)
   */
  public static <E extends Style.HasCssName, F extends Enum<? extends Style.HasCssName>>
      void addUniqueEnumStyleName(
  ...
  /**
   * Removes all CSS style names specified by an enum that implements {@link Style.HasCssName} from
   * an UIObject.
   *
   ...
   */
  public static <E extends Enum<? extends Style.HasCssName>> void removeEnumStyleNames(
      final UIObject uiObject, final Class<E> enumClass) {
   ...
   */
  public static <E extends Style.HasCssName> void addEnumStyleName(
      final UIObject uiObject, final E style) {
   ...
   * @param style Style name
   */
  public static <E extends Style.HasCssName> void removeEnumStyleName(
      final UIObject uiObject, final E style) {
   ...
   */
  public static void toggleStyleName(
      final UIObject uiObject, final boolean toggleStyle, final String styleName) {
    if (toggleStyle) {
   ...
   */
  public static void setHiddenOn(final UIObject uiObject, final DeviceSize deviceSize) {
   ...
   * @param deviceSize device size
   */
  public static void setVisibleOn(final UIObject uiObject, final DeviceSize deviceSize) {
    // Split the enum up by _ to get the different devices
    // Separates the SM_MD into [SM, MD] so we can add the right styles
    final String[] deviceString = deviceSize.name().split("_");
