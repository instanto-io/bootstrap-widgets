package io.instanto.bootstrap5.client.ui.gwt;
...
import io.instanto.bootstrap5.client.ui.constants.TableType;
...
public class DataGrid<T> extends com.google.gwt.user.cellview.client.DataGrid<T>
   ...
   *
   * @param pageSize the page size
   * @param keyProvider an instance of ProvidesKey, or null if the record object should act as its
   *     own key
   */
