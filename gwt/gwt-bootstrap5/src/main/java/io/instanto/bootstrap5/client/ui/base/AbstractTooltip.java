...
public abstract class AbstractTooltip
  ...
  public void setPlacement(Placement placement) {
    this.placement =
        placement == null || placement == Placement.DEFAULT ? Placement.TOP : placement;
    reconfigure();
  }
  ...
  protected final void initializePlugin(String content) {
    ...
    bindEvents(element);
    BootstrapComponent.createPlugin(
        element,
        getBootstrapPluginName(),
        animated,
        html,
