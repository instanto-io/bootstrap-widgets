 ...
 *
 * <p>Same shape as the Bootstrap 3 switcher, built on the Bootstrap 5 dropdown: {@link
 * ListDropDown} owns its toggle and menu, so items are added through it rather than assembled by
 * hand.
 */
