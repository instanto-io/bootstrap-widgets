 ...
 *
 * <p>We sort based on priority first, then insertion order. The hashCode and equals function should
 * prevent a set from containing 2 validators of the same type.
 *
