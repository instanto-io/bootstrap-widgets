...
public class SummernoteImageUploadEvent extends GwtEvent<SummernoteImageUploadHandler> {
    ...
    public static class ImageFile extends JavaScriptObject {
        ...
        public ImageFile(org.teavm.jso.JSObject value) { super(value); }

        public final String getName() { return name(unwrap()); }
        @org.teavm.jso.JSBody(params="e",script="return e.name;") private static native String name(org.teavm.jso.JSObject e);

        public final double getSize() { return size(unwrap()); }
        @org.teavm.jso.JSBody(params="e",script="return e.size;") private static native double size(org.teavm.jso.JSObject e);

        public final String getType() { return type(unwrap()); }
        @org.teavm.jso.JSBody(params="e",script="return e.type;") private static native String type(org.teavm.jso.JSObject e);
