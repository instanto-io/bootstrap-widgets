 ...
 *
 * <p>Not a port: this is the same ShowcaseEntryPoint the GWT build compiles, reached through the
 * same onModuleLoad GWT calls. The only thing this class supplies is what GWT's module system would
 * have -- where the assets live, and the call to start.
 */
