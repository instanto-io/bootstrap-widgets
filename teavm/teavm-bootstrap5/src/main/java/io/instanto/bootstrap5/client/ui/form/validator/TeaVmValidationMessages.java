 ...
 *
 * <p>Messages are resolved at runtime, so one build serves every language and the locale can change
 * without reloading.
 *
 * <p>To add a language, ship {@code ValidationMessages_&lt;lang&gt;.properties} beside the default
 * and add its base name to {@code META-INF/services/java.util.ResourceBundle}; TeaVM inlines every
 * bundle listed there at build time.
 */
public class TeaVmValidationMessages implements ValidationMessages {
  ...
  public String org_gwtbootstrap5_validation_DecimalMax_message() {
    return lookup(
        "org_gwtbootstrap5_validation_DecimalMax_message",
  ...
  public String org_gwtbootstrap5_validation_DecimalMin_message() {
    return lookup(
        "org_gwtbootstrap5_validation_DecimalMin_message",
