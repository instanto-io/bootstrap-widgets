...
public class Bootstrap5FormSteps {
  ...
  private void createFixture(String fixture, boolean mounted) {
    switch (fixture) {
      ...
      case "behaviour/form/text-label":
        ...
        label = new FormLabel("Account name");
        textBox = new TextBox();
  ...
  private void createValidationFixture(boolean mounted) {
    ...
    label = new FormLabel("Required value");
    textBox = new TextBox();
  ...
  public void invalidFrameworkClassIsPresent() {
    expect(element(textBox)).toHaveClass("is-invalid");
  }
  ...
  public void fieldDescriptionNamesMessage() {
    assertAttributeContains(
        textBox.getElement().getAttribute("aria-describedby"),
